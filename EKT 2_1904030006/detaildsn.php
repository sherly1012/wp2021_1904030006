...
$id = $_GET['id'];
$dsn = query("SELECT * FROM daftar_dosen WHERE nind=$id");
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item">nind : <?= $dsn['nind']; ?></li>
        ...
        <li class="list-group-item">
          <a href="hapusdsn.php?id=<?= $dsn['nind']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
